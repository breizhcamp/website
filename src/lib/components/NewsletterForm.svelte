...
<script>
	...
	onMount(() => {
		...
		// @ts-expect-error Brevio code I don't understand...
	...
	<div id="sib-form-container" class="sib-form-container">
		...
		>
			<form
				id="sib-form"
				method="POST"
				action="https://3f47f7a8.sibforms.com/serve/MUIFAE8o8iAonNrLyhXZ4XCai2y0lsBwz8AKjL-f3kBTrlh_uwmj8MI3Q0DloWGg4DezYadT7nubgnSgfqmz7-Oay0qIlaA3vpjHBdQmxpgC7LfAm7Fgu_TYcx0W1sSMOPixzB-6AmA_xsThdKbMBthcxnfnzez8UnVQ7FtnG15Y2FYHheotY9yAlKDKhC3fEIgspITAs-eZhq_c2g=="
				data-type="subscription"
			>
				<!-- <div style="padding: 8px 0;">
					<div class="sib-form-block sib-image-form-block" style="text-align: center">
						<img
							src="https://img.mailinblue.com/10729914/images/content_library/original/69da3a445283d836eca8e29a.png"
							style="width: 500px;height: 149px;"
							alt=""
							title=""
						/>
					</div>
						...
						<div class="form__entry entry_block">
							<div class="form__label-row">
								<label
									...
									for="EMAIL"
									data-required="*"
									>Entrez votre adresse email pour vous inscrire</label
								>
						...
						<div class="form__entry entry_block">
							<div class="form__label-row">
								<label
									...
									style="font-weight: 700; text-align:left; font-size:16px; font-family:Helvetica, sans-serif; color:#3c4858;"
									for="PRENOM"
									data-required="*">Entrez votre prénom</label
								>
						...
						<div class="form__entry entry_mcq">
							<div class="form__label-row">
								<label
									...
									style="font-weight: 700; text-align:left; font-size:16px; font-family:Helvetica, sans-serif; color:#3c4858;"
									for="OPTIN_FORM"
									data-required="*">Confirmation</label
								>
								<div class="entry__choice" style="">
									<label>
										...
										></span><span
											...
											><p>
												J'accepte de recevoir des e-mails pour être informé
												des nouvelles du BreizhCamp.
											</p></span
										>
									</label>
								</div>
					...
					<div class="sib-form__declaration" style="direction:ltr">
						...
						>
							<p>
								...
								ce formulaire, vous acceptez que les données personnelles que vous
								avez fournies soient transférées à Brevo pour être traitées
								conformément <a
									href="https://www.brevo.com/fr/legal/privacypolicy/"
									target="_blank">à la politique de confidentialité de Brevo</a
								>.
							</p>
						</div>
					</div>
