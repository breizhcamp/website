...
Il y a, à ce jour, trop d'inconnues sur la faisabilité de l'événement liées à l'épidémie de coronavirus ; et prendre cette décision aujourd'hui nous permet d'avoir un délai de prévenance raisonnable vis-à-vis de toutes les personnes concernées (participants, orateurs, sponsors, prestataires…).
...
- Remboursement automatique sur le moyen de paiement utilisé
- Aucune démarche de votre part
- Délai de traitement : 7 à 10 jours ouvrés

### Pour les sponsors

- Contact direct de notre équipe
- Remboursement ou report sur l'édition suivante
