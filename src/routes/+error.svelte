		...
		switch (status) {
			case 404:
				return {
					...
					message: "Oups ! Cette page semble s'être perdue dans les méandres du web breton.",
				...
				<div class="error-icon">
					{#if $page.status === 404}
						...
						<svg viewBox="0 0 100 100" fill="none">
							<circle cx="50" cy="50" r="45" stroke="var(--violet)" stroke-width="3" fill="none" opacity="0.3"/>
							<circle cx="50" cy="50" r="35" stroke="var(--orange)" stroke-width="2" fill="none"/>
							<path d="M50 15 L55 35 L50 50 L45 35 Z" fill="var(--violet)" opacity="0.7"/>
							<path d="M85 50 L65 55 L50 50 L65 45 Z" fill="var(--orange)" opacity="0.7"/>
							<circle cx="50" cy="50" r="3" fill="var(--neutral-800)"/>
							<text x="50" y="25" text-anchor="middle" font-size="8" fill="var(--violet)" font-weight="bold">N</text>
						</svg>
					{:else if $page.status === 500}
						<!-- Icône serveur en panne -->
						<svg viewBox="0 0 100 100" fill="none">
							<rect x="20" y="30" width="60" height="40" rx="4" stroke="var(--violet)" stroke-width="3" fill="none"/>
							<rect x="25" y="35" width="50" height="8" fill="var(--orange)" opacity="0.7"/>
							...
							<path d="M35 20 L45 10 L55 20" stroke="var(--neutral-400)" stroke-width="2" fill="none"/>
							<path d="M65 20 L75 10 L85 20" stroke="var(--neutral-400)" stroke-width="2" fill="none"/>
						</svg>
					{:else}
						<!-- Icône générique -->
						<svg viewBox="0 0 100 100" fill="none">
							<circle cx="50" cy="50" r="40" stroke="var(--violet)" stroke-width="3" fill="none"/>
							<path d="M35 35 L65 65 M65 35 L35 65" stroke="var(--orange)" stroke-width="4" stroke-linecap="round"/>
						</svg>
					{/if}
				</div>
			</div>
			...
			<Card>
				<div class="encouragement-content">
					...
					<p>
						...
						n'hésitez pas à nous contacter. L'équipe BreizhCamp est là pour vous aider !
					</p>
					<div class="contact-actions">
						<Button variant="link" href="mailto:contact@breizhcamp.org">
							Nous contacter
						</Button>
						<Button variant="link" href="/infos-pratiques#faq">
							Consulter la FAQ
						</Button>
					</div>
				</div>
